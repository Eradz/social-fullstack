...
export const Choose = () => {
  ...
  const choice = [
    ...
    {name: "Money Quarantee", detail:"30 Days Money Bac", icon: <FaRegMoneyBillAlt/>, bg:'bg-green-700' },
    {name: "24/7 Support", detail:"Friendly support 24/", icon: <BsChatLeftText/>, bg:'bg-purple-700'}
  ]
  return (
    <div className='mt-5'>
